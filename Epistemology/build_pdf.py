#!/usr/bin/env python3
"""
build_pdf.py — Build "Epistemology: Theory of Knowledge" as a PDF.
...
DEFAULT_OUT = BOOK_ROOT / "epistemology.pdf"

YAML_HEADER = """\
---
title: "Epistemology: Theory of Knowledge"
subtitle: "From Justified Belief to Social and Formal Epistemology"
documentclass: book
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build Epistemology PDF.")
    ...
    print("Building Epistemology textbook PDF\n" + "=" * 35)
