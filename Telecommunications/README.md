...
| **[book/figures/](book/figures/)** | Sixteen computed SVG figures embedded in the text — each plots the actual formula or simulation it illustrates, generated by `tools/make_figures.py` |
