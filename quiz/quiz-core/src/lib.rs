...
pub use config::{ChapterMeta, SubjectConfig, resolve_subject_dir, title_slug};
pub use generator::{ClaudeGenerator, resolve_model, DEFAULT_MODEL};
...
pub use question::{
    Difficulty, Question, Quiz, load_question_bank, load_question_pool, load_questions, load_quiz,
};
